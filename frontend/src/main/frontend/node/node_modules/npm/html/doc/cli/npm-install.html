...
common options: [-P|--save-prod|-D|--save-dev|-O|--save-optional] [-E|--save-exact] [-B|--save-bundle] [--no-save] [--dry-run]</code></pre>
  ...
  <ul>
    ...
    <li>e) a <code>&lt;name&gt;@&lt;tag&gt;</code> (see <code><a
      href="../cli/npm-dist-tag.html">npm-dist-tag(1)</a></code>) that points to (d)
    </li>
  ...
  <ul>
    ...
    <li><p><code>npm install &lt;tarball file&gt;</code>:</p>
      ...
      <ul>
        ...
        <li><p>The package contents should reside in a subfolder inside the tarball (usually it is called
          <code>package/</code>). npm strips one directory layer when installing the package (an equivalent of <code>tar
            x --strip-components=1</code> is run).</p>
        </li>
    ...
    <li><p><code>npm install [&lt;@scope&gt;/]&lt;name&gt;</code>:</p>
      ...
      <ul>
        ...
        <li><p><code>-B, --save-bundle</code>: Saved dependencies will also be added to your
  ...
  <ul>
    ...
    <li><p><code>npm install [&lt;@scope&gt;/]&lt;name&gt;@&lt;version range&gt;</code>:</p>
      <p> Install a version of the package matching the specified version range. This
        will follow the same rules for resolving dependencies described in <code><a href="../files/package.json.html">package.json(5)</a></code>.
      </p>
...
GIT_SSH_COMMAND=&#39;ssh -i ~/.ssh/custom_ident&#39; npm install git+ssh://git@github.com:npm/cli.git</code></pre>
    ...
    <li><p><code>npm install gist:[&lt;githubname&gt;/]&lt;gistID&gt;[#&lt;commit-ish&gt;|#semver:&lt;semver&gt;]</code>:
    </p>
  ...
  <p>The <code>--no-audit</code> argument can be used to disable sending of audit reports to
    the configured registries. See <code><a href="../cli/npm-audit.html">npm-audit(1)</a></code> for details on what is
    sent.</p>

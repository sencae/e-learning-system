...
Sets tag &#39;latest&#39; if no --tag specified</code></pre>
  ...
  <p>Publishes a package to the registry so that it can be installed by name. All
    ...
    <code><a href="../misc/npm-developers.html">npm-developers(7)</a></code> for full details on what&#39;s included in
    the published
  ...
  <p>By default npm will publish to the public registry. This can be overridden by
    specifying a different default registry or using a <code><a href="../misc/npm-scope.html">npm-scope(7)</a></code> in
    the name
  ...
  <ul>
    ...
    <li><p><code>[--tag &lt;tag&gt;]</code>
      ...
      and <code>npm install</code> installs the <code>latest</code> tag. See <code><a href="../cli/npm-dist-tag.html">npm-dist-tag(1)</a></code>
      for

...
git+https://user@hostname/project/blah.git#commit-ish</code></pre>
  ...
  <p>See <code><a href="../files/package.json.html">package.json(5)</a></code> for details about what goes in that file.
    At the very
    least, you need:</p>
  <ul>
    <li><p>name:
  ...
  <p><code>.npmignore</code> files follow the <a
    href="https://git-scm.com/book/en/v2/Git-Basics-Recording-Changes-to-the-Repository#Ignoring-Files">same pattern
    rules</a>

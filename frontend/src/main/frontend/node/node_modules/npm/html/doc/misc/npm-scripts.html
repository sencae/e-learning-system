...
<div id="wrapper">
  ...
  <ul>
    ...
    <li>prepare:
      ...
      AFTER <code>prepublish</code>, but BEFORE <code>prepublishOnly</code>.
    </li>
    <li>prepublishOnly:
  ...
  <p>Since <a href="mailto:%60npm@1.1.71">`npm@1.1.71</a><code>, the npm CLI has run the</code>prepublish<code>script
    ...
    publish<code>and</code>npm install<code>, because it&#39;s a convenient way to prepare a package
      ...
      confusing](https://github.com/npm/npm/issues/10074). As of</code><a href="mailto:npm@4.0.0">npm@4.0.0</a><code>, a
      new
...
, &quot;scripts&quot;: { &quot;start&quot; : &quot;bar ./test&quot; } }</code></pre>
  ...
  <p>The package.json fields are tacked onto the <code>npm_package_</code> prefix. So,
    for instance, if you had <code>{&quot;name&quot;:&quot;foo&quot;, &quot;version&quot;:&quot;1.2.5&quot;}</code> in
    your
...
, &quot;scripts&quot; : { &quot;start&quot; : &quot;node server.js&quot; } }</code></pre>
  ...
  <ul>
    ...
    <li>Try not to use scripts to do what npm can do for you. Read through
      <code><a href="../files/package.json.html">package.json(5)</a></code> to see all the things that you can specify
      and enable

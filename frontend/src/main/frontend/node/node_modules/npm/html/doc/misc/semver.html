...
1.2.4-beta.1</code></pre>
  ...
  <ul>
    ...
    <li><code>~1.2</code> := <code>&gt;=1.2.0 &lt;1.(2+1).0</code> := <code>&gt;=1.2.0 &lt;1.3.0</code> (Same as <code>1.2.x</code>)
    </li>
    ...
    <li><code>~0.2</code> := <code>&gt;=0.2.0 &lt;0.(2+1).0</code> := <code>&gt;=0.2.0 &lt;0.3.0</code> (Same as <code>0.2.x</code>)
    </li>
...
part       ::= nr | [-0-9A-Za-z]+</code></pre>
  ...
  <ul>
    ...
    <li><code>diff(v1, v2)</code>: Returns difference between two versions by the release type
      (<code>major</code>, <code>premajor</code>, <code>minor</code>, <code>preminor</code>, <code>patch</code>, <code>prepatch</code>,
      or <code>prerelease</code>),
  ...
  <ul>
    ...
    <li><code>outside(version, range, hilo)</code>: Return true if the version is outside
      ...
      <code>hilo</code> argument must be either the string <code>&#39;&gt;&#39;</code> or <code>&#39;&lt;&#39;</code>.
      (This is
